        ...
        <div className="hidden sm:flex items-center gap-3" ref={searchRef}>
          ...
          <div className="relative" ref={inviteRef}>
            <button
              ...
              className="inline-flex h-11 items-center gap-2 rounded-button bg-primary px-4 text-sm font-semibold text-on-primary shadow-sm transition hover:bg-primary-hover focus:outline-none focus:ring-4 focus:ring-primary/20"
            >
            ...
            {inviteMenuOpen && (
              <div className="absolute right-0 mt-2 z-sidebar w-52 rounded-card border border-border bg-card-elevated p-2 shadow-dropdown animate-[teamora-content-fade_180ms_ease-out_both]">
                <button
                  type="button"
                  onClick={() => {
                    setInviteMenuOpen(false)
